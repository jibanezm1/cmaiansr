...
?>
<section class="page-title bg-overlay-black-60 parallax" data-jarallax='{"speed": 0.6}' style="background-image: url(<?php echo $model->banner; ?>);">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="page-breadcrumb">
                    ...
                    <li><a href="<?php echo Url::to(['categoria', 'id' => 1]); ?>"><?php echo $model->nombre; ?></a> </li>
                </ul>
            </div>
        </div>
    </div>
...
<script>
    ...
    jQuery(window).scroll(function() {
        ...
        function mycontent(mypage) {
            ...
            $.get('../categoria/cargar?page=' + mypage + '&categoria=<?php echo $model->id; ?>',
                function(data) {
